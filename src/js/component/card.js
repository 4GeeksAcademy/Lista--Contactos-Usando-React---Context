    ...
    return (
            ...
            <div className="border border-2 border-dark p-3 mx-auto w-75 row">
                ...
                <article className=" col-6 d-flex flex-column" style={{marginLeft:' 4rem'}}>
                    ...
                    <p><i className="me-3 fa-solid fa-location-dot"></i>5842 Hillcrest Rd</p>
                    <p><i className="me-3 fa-solid fa-phone"></i>(870) 288-4149</p>
                    <p><i className="me-3 fa-solid fa-envelope"></i>mike.ana@example.com</p>
